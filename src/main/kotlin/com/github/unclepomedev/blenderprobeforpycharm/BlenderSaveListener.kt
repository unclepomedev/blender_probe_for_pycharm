...
/**
 * Listener for file save events to trigger automatic reload of the Blender addon. When Python files
 * within the project are modified and saved, this listener schedules a reload.
 */
class BlenderSaveListener(private val project: Project) : BulkFileListener {

    /**
     * Called after files have been processed. Checks if any Python files in the project were
     * modified and schedules a reload.
     *
