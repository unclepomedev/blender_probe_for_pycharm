...
/**
 * Options for the Blender Test run configuration. Stores persistent settings such as the test
 * directory.
 */
class BlenderTestRunConfigurationOptions : RunConfigurationOptions() {
    private val testDirProperty: StoredProperty<String?> =
        string("").provideDelegate(this, "testDir")
