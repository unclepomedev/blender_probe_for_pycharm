...
class BlenderStubService(private val project: Project) {
    ...
    fun generateStubs(blenderPath: String) {
        ...
        ProgressManager.getInstance()
            .run(
                object : Task.Backgroundable(project, "Generating Blender stubs...", true) {
                    ...
                    override fun run(indicator: ProgressIndicator) {
                        ...
                        try {
                            ...
                            executionLog =
                                runBlenderProcess(blenderPath, scriptPath, outputDir, indicator)
                            ...
                            notifyUser(
                                "Generation Failed",
                                "Failed to generate stubs: ${ex.message}",
                    ...
                    override fun onSuccess() {
                        ...
                        if (!ApplicationManager.getApplication().isHeadlessEnvironment) {
                            notifyUser(
                                "Success",
                                "Stubs generated in .blender_stubs",
                                NotificationType.INFORMATION,
                            )
                        }
    ...
    private fun prepareGeneratorEnvironment(tempDir: File, indicator: ProgressIndicator): String {
        ...
        val manifestStream =
            this::class.java.classLoader.getResourceAsStream(manifestPath)
        ...
        if (!mainScript.exists()) {
            throw ExecutionException(
                "Main script 'generate_stubs.py' was not found in the extracted files."
            )
        }
