...
def generate_module_recursive(module_name: str, base_output_dir: str):
    ...
    doc_url = get_api_docs_link(module_name)
    module_doc = (
        f'"""\n'
        f'This stub was dynamically generated by Blender Probe.\n'
        f'Argument types might be generic (*args) for C-based modules.\n\n'
...
def get_api_docs_link(module_name):
